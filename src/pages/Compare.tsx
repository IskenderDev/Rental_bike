				...
				<CardHeader className="flex justify-between flex-row">
					<div>
                                                <CardTitle className="font-orbitron tracking-wider">
                                                        Сравнение велосипедов
                                                </CardTitle>
                                                <CardDescription>
                                                        Управляйте списком и следите за эффективностью продаж
                                                </CardDescription>
					</div>

					<div className="text-xs text-muted-foreground">
                                                <Button onClick={handleRemoveAll}>Очистить список</Button>
					</div>
				</CardHeader>
				<CardContent>
						...
						<>
							<div className="w-1/3 py-20 mx-auto col-span-full">
                                                                ...
                                                                <h2 className="text-center font-orbitron lg:text-5xl md:text-3xl text-xl font-bold">
                                                                        Велосипеды для сравнения не найдены
                                                                </h2>
							</div>
						</>
					)}
